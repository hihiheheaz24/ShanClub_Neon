...
cc.Class({
    ...
    start(){
        var urlRule =  require('GameManager').getInstance().url_rule.replace("%gameid%", require('GameManager').getInstance().curGameId);
        //var urlRule = 'http://192.168.1.7:8000'
        //var urlRule = 'http://192.168.1.170:8000?gameid=' + require('GameManager').getInstance().curGameId +  '&show=false';
