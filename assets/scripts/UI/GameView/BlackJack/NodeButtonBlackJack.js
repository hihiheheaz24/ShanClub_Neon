...
cc.Class({
    ...
    onClick(event ,data){
        ...
        let playerAg = require('GameManager').getInstance().user.ag;
        switch(num){
            case 0:
               ...
               // if (this.chipUser < this.chipCuoc) {
                    cc.NGWlog('chippp player dang co la ===  ' + this.chipUser + 'chipppp cuoc la ===  '+ this.chipCuoc + 'tai sao ko cho double ??? ');
            ...
            case 1:
                ...
                //if (this.chipUser < this.chipCuoc) {
                    cc.NGWlog('chippp player dang co la ===  ' + this.chipUser + 'chipppp cuoc la ===  '+ this.chipCuoc + 'tai sao ko cho tasch ??? ');
