cc.Class({
    ...
    setSprChipBet() {
        ...
        for (let i = 0; i < length; i++) {
            ...
            labelText.string = require("GameManager").getInstance().formatMoneyChip(this.listValue[i]).replace(/(.)(?=(\d{3})+$)/g, '$1,').toUpperCase();
            ...
            this.listBtnBetChip[i].node.addChild(labelText.node);
        }
    },
    setStateButton() {
