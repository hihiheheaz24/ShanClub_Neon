...
cc.Class({
    ...
    checkShowRedDot() {
        ...
        cc.NGWlog("Size mail admin:="+GameManager.getInstance().mail20.length);
        ...
        cc.NGWlog("Size mail player:="+GameManager.getInstance().mail21.length);
    ...
    handleDataMailAdmin(jsData) {
        ...
        for (let i = 0; i < jsData.length; i++) {
            ...
            if (item.from.toLowerCase().localeCompare("adminsiam") == 0 || item.from.toLowerCase().localeCompare("admin") == 0) {
    ...
    reloadList() {
        cc.NGWlog("tab_select==" + this.tab_select);
        if (this.tab_select === 0) {
            this.btn_player.isChecked = true;
            this.btn_admin.isChecked = false;
            this.reloadListMailPlayer();
    ...
    reloadListMailPlayer() {
        ...
        cc.NGWlog("mail player size=" + dataSize);
    ...
    onClickCheckAll() {
        ...
        if (this.tab_select == 0) {
            cc.NGWlog("Tab Seclecting="+this.tab_select);
