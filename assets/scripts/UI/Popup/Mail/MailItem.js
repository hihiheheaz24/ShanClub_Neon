...
cc.Class({
    ...
    setInfo(data, type) {
        ...
        let indexEnter = -1;
        indexEnter = data.msg.indexOf('\n');
        if (indexEnter != -1) {
            data.msg = data.msg.substring(0, indexEnter) + "...";
        ...
        this.avatar.node.getComponent("AvatarItem").loadTexture(data.avatar_id, this.name_player);
        this.isInit = false;
    },
    onClickItem() {
