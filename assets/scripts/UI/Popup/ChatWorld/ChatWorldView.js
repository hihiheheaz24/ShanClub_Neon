...
cc.Class({
    ...
    moveUp() {
        ...
        require('TrackingManager').SendTracking(TRACKING_TYPE.ClickChatWorld);
    ...
    updateListChat() {
        cc.NGWlog("chay vao update lít chat");
    ...
    onClickSend() {
        ...
        if(this._isChat){
            require("UIManager").instance.onShowConfirmDialog(require("GameManager").getInstance().getTextConfig("txt_spamchat"));
            return;
        }
        if (this.edbox.string.length > 0) {
