...
var LoadingBar = cc.Class({
  ...
  onEnable() {
    // this.ramdom_int =  (Math.floor(Math.random() * 11 ) + 10) * 0.01;
    // cc.NGWlog('====================> int ramdom la ' + this.ramdom_int);
    this.loading_on.fillRange =0; //this.ramdom_int;
    this.stt_text = this.generateRandomNumber(0, 10);
    this.stt_bg = this.generateRandomNumber(0, 4);
    this.lb_per.string = "Loading: " + 0 /*Math.round(this.ramdom_int*100)*/ + "%"
  },
