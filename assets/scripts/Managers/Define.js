...
var GAME_ID = {
    ...
    // SLOT100LINE: 1008,
    ROULETTE: 1111,
    SLOT50LINE: 8818, // doi cho 20.tam thoi
    TONGITS: 8088,
    XOCDIA : 8813,
    SHOW: 8808,
    BAUCUA:8803,
...
var GAME_INFO = {
    ...
    8802:{
        urlAssets:'prefab/ShanClubGameView',
        component: 'ShanClubView',
        isPlayNow: false,
        handleScritps: 'ShanClubHandleData',
    ...
    8818:{
        urlAssets:'prefab/Slot20Noel',
        component : "Slot20NoelView",
        isPlayNow: true,
        handleScritps : 'HandleSlot20Noel',
        delayEvt : []
    },
    1001:{
        urlAssets:'prefab/ShanKoeMee',
        component : "ShanGameView",
        isPlayNow: false,
        handleScritps : 'HandleShanKoeMee',
        delayEvt : []
    },
    8088:{
        urlAssets:'prefab/TongitsGameView',
        component : "TongitsGameView",
        isPlayNow: false,
        handleScritps : 'HandleTongits',
        delayEvt : ['bc'],
    },
    8819: {
        urlAssets: 'prefab/BurmesePoker',
        component: "BurmesePokerView",
        isPlayNow: false,
        handleScritps: 'HandleParseDataBurmesePoker',
        delayEvt: []
    }
}
var EFFECT_TYPE = {
