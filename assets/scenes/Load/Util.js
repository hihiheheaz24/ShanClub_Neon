...
var GET_API_AVAILABLE = "27"; //for IOS
var SIGN_WITH_APPLE_ID = "28"; //for IOS
...
cc.NativeCallJS = function (evt, params) {
    ...
    switch (evt) {
        ...
        case LOGIN_FACEBOOK:
            ...
            break;
        case SIGN_WITH_APPLE_ID:
            cc.NGWlog('tra ve identityTokenAppleID la===' + params);
            require('GameManager').getInstance().identityTokenAppleID = params;
            require('NetworkManager').getInstance().onLogin("1", params, false);
            break;
        case VEYRY_PHONE:
            let phone = params;
...
var Util = cc.Class({
    statics: {
        ...
        getAPI_AVAILABLE() {
            cc.NGWlog("Call getAPI_AVAILABLE IOS1");
            return Util.onCallNative(GET_API_AVAILABLE, "");
        },
        signWithApple() {
            cc.NGWlog("Call signWithApple IOS");
            Util.onCallNative(SIGN_WITH_APPLE_ID, "");
        }
    }
});
